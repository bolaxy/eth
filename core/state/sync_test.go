...
func makeTestState() (Database, common.Hash, []*testAccount) {
	...
	db := NewDatabase(bolaxydb.NewMemDatabase())
...
// account array.
func checkStateAccounts(t *testing.T, db bolaxydb.Sinker, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db bolaxydb.Sinker, root common.Hash) error {
...
func checkStateConsistency(db bolaxydb.Sinker, root common.Hash) error {
...
func TestEmptyStateSync(t *testing.T) {
	...
	if req := NewStateSync(empty, bolaxydb.NewMemDatabase()).Missing(1); len(req) != 0 {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(bolaxydb.Sinker), srcRoot)
