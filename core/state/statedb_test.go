...
func TestIntermediateLeaks(t *testing.T) {
	...
	transDb := bolaxydb.NewMemDatabase()
	finalDb := bolaxydb.NewMemDatabase()
...
func TestCopy(t *testing.T) {
	...
	orig, _ := New(common.Hash{}, NewDatabase(bolaxydb.NewMemDatabase()))
...
func (test *snapshotTest) run() bool {
	...
	var (
		state, _     = New(common.Hash{}, NewDatabase(bolaxydb.NewMemDatabase()))
...
func TestCopyOfCopy(t *testing.T) {
	sdb, _ := New(common.Hash{}, NewDatabase(bolaxydb.NewMemDatabase()))
